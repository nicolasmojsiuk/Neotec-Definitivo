...
public class IndexAController {
    ...
    public void mostrarMejoresClientes() {CargarPantallas.cargar(workspace,"/vistas/verMejoresClientes.fxml");}
    public void mostrarProductosMasVendidos() {CargarPantallas.cargar(workspace,"/vistas/verProductosMasVendidos.fxml");}
    public void mostrarGanancias() {CargarPantallas.cargar(workspace,"/vistas/verGanancias.fxml");}
